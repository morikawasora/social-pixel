...
<div class="main" id="mainContent">
  ...
  <img src="<?= $iconPath ?>" alt="アイコン" class="profile-icon">

  <p><strong>ユーザー名:</strong> <?= htmlspecialchars($user['username']) ?></p>
  <p><strong>メールアドレス:</strong> <?= htmlspecialchars($user['email'] ?? '未登録') ?></p>
  <p><strong>自己紹介:</strong><br><?= nl2br(htmlspecialchars($user['bio'] ?? '未記入')) ?></p>
